...
export const CAD_LAYERS = [
  ...
  { id: "senales", label: "Señales y datos", color: "#0891b2", locked: false },
...
export const CAD_SYMBOLS = [
  ...
  { id: "sub-panel", label: "Sub-tablero", layer: "tablero", kind: "equipment", ports: ["in", "out", "pe"] },
  { id: "meter", label: "Medidor/empalme", layer: "tablero", kind: "equipment", ports: ["in", "out"] },
  { id: "breaker", label: "Proteccion", layer: "tablero", kind: "protection", ports: ["in", "out"] },
  { id: "differential", label: "Diferencial", layer: "tablero", kind: "protection", ports: ["in", "out"] },
  { id: "light", label: "Punto luz", layer: "alumbrado", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "emergency-light", label: "Luminaria de emergencia", layer: "alumbrado", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "switch", label: "Interruptor", layer: "alumbrado", kind: "control", ports: ["in", "out"] },
  { id: "three-way-switch", label: "Conmutación (cruzamiento)", layer: "alumbrado", kind: "control", ports: ["in", "out"] },
  { id: "dimmer", label: "Regulador (dimmer)", layer: "alumbrado", kind: "control", ports: ["in", "out"] },
  { id: "motion-sensor", label: "Sensor de movimiento", layer: "alumbrado", kind: "control", ports: ["in", "out"] },
  { id: "doorbell", label: "Timbre", layer: "alumbrado", kind: "load", ports: ["phase", "neutral"] },
  ...
  { id: "outlet-exterior", label: "Enchufe exterior IP44", layer: "enchufes", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "outlet-special", label: "Enchufe especial (fuerza)", layer: "fuerza", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "outlet-tripolar", label: "Enchufe trifásico", layer: "fuerza", kind: "load", ports: ["r", "s", "t", "n", "pe"] },
  { id: "motor", label: "Motor/carga fuerza", layer: "fuerza", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "exhaust-fan", label: "Extractor/ventilador", layer: "fuerza", kind: "load", ports: ["phase", "neutral", "pe"] },
  { id: "water-heater", label: "Calefón/termo", layer: "fuerza", kind: "load", ports: ["phase", "neutral", "pe"] },
  ...
  { id: "smoke-detector", label: "Detector de humo", layer: "senales", kind: "signal", ports: [] },
  { id: "data-point", label: "Punto de red (datos)", layer: "senales", kind: "signal", ports: [] },
  { id: "tv-point", label: "Punto de TV", layer: "senales", kind: "signal", ports: [] },
