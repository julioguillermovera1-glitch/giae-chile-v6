export const NORMATIVE_SOURCES = [
  ...
  { id: "DS8", label: "Decreto Supremo N°8 de Chile", priority: 3 }
];

export function strictNormativeMessage() {
  return "GIAE Chile entrega criterios técnicos solo cuando existe respaldo en RIC, IEC o Decreto Supremo N°8 de Chile. Si la base local no contiene una regla suficiente, el sistema debe indicar revisión normativa y no inventar datos.";
}
