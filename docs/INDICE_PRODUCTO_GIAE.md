# Indice de producto GIAE

Este indice conecta la documentacion estrategica con los datos estructurados del repositorio.

## Documentos vigentes

- ROADMAP_6_FASES_GIAE_CHILE.md
- GIAE_2_0_CAD_DOCUMENTOS_RAZONAMIENTO.md
...
- FASE_5_6_FLUJO_GUIADO_GIAE.md
- ESPECIFICACION_MAESTRA_GIAE_CHILE.md
- FLUJO_GUIADO_GIAE_V1.md
- ORIGINALIDAD.md
...
- docs/data/producto/fase-5-6-flujo-guiado.json
- docs/data/producto/fase-5-6-flujo-guiado-last-report.json
...
Si una decision de desarrollo no aparece en estos documentos o datos, debe agregarse antes de implementarse.
