...
GIAE.demo={
  ...
  revisar(){
    // v6.1: nunca recuerda localStorage ni entra solo.
  ...
  generar(){
    ...
    const html=`<div class="report informe-auto">
      <div class="portada-giae">
        ...
        <p><b>Versión:</b> v6.1 Generador Automático de Informes</p>
      </div>
      <hr>
...
/* v6.1 Corrección de Publicación - módulos profesionales forzados */
...
GIAE.exportacionPro={
  ...
  generarBase(){
    ...
    this.ultimo=`<div class="report informe-pro">
      <div class="portada-giae">
        ...
        <p><b>Versión:</b> v6.1 Exportación Profesional</p>
        <p><b>Fecha:</b> ${fecha}</p>
      </div>
  ...
  excel(){
    ...
    const cargas=GIAE.state.cargas||[];
    const e=GIAE.state.resultados?.empalme||{};
    let html=`<table><tr><th colspan="2">GIAE Chile v6.1 - Datos del Proyecto</th></tr>
