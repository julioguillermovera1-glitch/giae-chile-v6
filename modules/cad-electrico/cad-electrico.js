...
function renderSymbol(entity, symbols = CAD_SYMBOLS){
  ...
  if(entity.symbolId === "sub-panel") return `<g ${base} transform="translate(${x} ${y})"><rect x="-28" y="-34" width="56" height="68" rx="4" fill="none" stroke="${color}" stroke-width="2.5" stroke-dasharray="6 3"/><line x1="-16" y1="-14" x2="16" y2="-14" stroke="${color}" stroke-width="1.5"/><line x1="-16" y1="8" x2="16" y2="8" stroke="${color}" stroke-width="1.5"/><text y="48" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "meter") return `<g ${base} transform="translate(${x} ${y})"><circle r="22" fill="none" stroke="${color}" stroke-width="2.5"/><line x1="0" y1="6" x2="10" y2="-10" stroke="${color}" stroke-width="2" stroke-linecap="round"/><circle r="2.5" fill="${color}"/><text y="42" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  ...
  if(entity.symbolId === "differential") return `<g ${base} transform="translate(${x} ${y})"><rect x="-22" y="-32" width="44" height="64" rx="3" fill="none" stroke="${color}" stroke-width="2"/><path d="M -10 8 C -2 -18 8 -18 14 -30" fill="none" stroke="${color}" stroke-width="2"/><circle cx="0" cy="20" r="5" fill="none" stroke="${color}" stroke-width="1.5"/><text y="50" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  ...
  if(entity.symbolId === "emergency-light") return `<g ${base} transform="translate(${x} ${y})"><circle r="25" fill="none" stroke="${color}" stroke-width="2.5"/><line x1="-17" y1="-17" x2="17" y2="17" stroke="${color}" stroke-width="1.5"/><line x1="17" y1="-17" x2="-17" y2="17" stroke="${color}" stroke-width="1.5"/><text y="6" text-anchor="middle" font-size="13" font-weight="900" fill="${color}">E</text><text y="46" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  ...
  if(entity.symbolId === "three-way-switch") return `<g ${base} transform="translate(${x} ${y})"><circle r="18" fill="none" stroke="${color}" stroke-width="2.5"/><line x1="-7" y1="6" x2="16" y2="-15" stroke="${color}" stroke-width="2"/><text x="8" y="-2" font-size="11" font-weight="800" fill="${color}">3</text><text y="40" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "dimmer") return `<g ${base} transform="translate(${x} ${y})"><circle r="18" fill="none" stroke="${color}" stroke-width="2.5"/><line x1="-7" y1="6" x2="16" y2="-15" stroke="${color}" stroke-width="2"/><circle cx="0" cy="0" r="6" fill="none" stroke="${color}" stroke-width="1.5"/><text y="40" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "motion-sensor") return `<g ${base} transform="translate(${x} ${y})"><circle r="18" fill="none" stroke="${color}" stroke-width="2.5"/><path d="M -12 -12 A 22 22 0 0 1 12 -12" fill="none" stroke="${color}" stroke-width="1.5"/><path d="M -16 -16 A 28 28 0 0 1 16 -16" fill="none" stroke="${color}" stroke-width="1.5"/><text y="40" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "doorbell") return `<g ${base} transform="translate(${x} ${y})"><path d="M -14 6 A 14 14 0 0 1 14 6 L 16 12 L -16 12 Z" fill="none" stroke="${color}" stroke-width="2"/><circle cx="0" cy="16" r="2.5" fill="${color}"/><text y="38" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet") return `<g ${base} transform="translate(${x} ${y})"><path d="M -24 0 A 24 24 0 0 1 24 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-24" y1="0" x2="24" y2="0" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="0" y1="-24" x2="0" y2="-34" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="45" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-double") return `<g ${base} transform="translate(${x} ${y})"><path d="M -26 0 A 26 26 0 0 1 26 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-26" y1="0" x2="26" y2="0" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-9" y1="-24" x2="-9" y2="-34" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="9" y1="-24" x2="9" y2="-34" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="50" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-triple") return `<g ${base} transform="translate(${x} ${y})"><path d="M -28 0 A 28 28 0 0 1 28 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-28" y1="0" x2="28" y2="0" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-12" y1="-24" x2="-12" y2="-35" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="0" y1="-28" x2="0" y2="-38" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="12" y1="-24" x2="12" y2="-35" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="52" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-exterior") return `<g ${base} transform="translate(${x} ${y})"><path d="M -24 0 A 24 24 0 0 1 24 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-24" y1="0" x2="24" y2="0" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><path d="M -28 -6 L 28 -6 L 22 -18 L -22 -18 Z" fill="none" stroke="${color}" stroke-width="1.5"/><text y="45" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-special") return `<g ${base} transform="translate(${x} ${y})"><path d="M -26 0 A 26 26 0 0 1 26 0" fill="none" stroke="${color}" stroke-width="3" stroke-linecap="round"/><line x1="-26" y1="0" x2="26" y2="0" stroke="${color}" stroke-width="3" stroke-linecap="round"/><line x1="0" y1="-26" x2="0" y2="-36" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><text y="16" text-anchor="middle" font-size="10" font-weight="800" fill="${color}">E</text><text y="50" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-tripolar") return `<g ${base} transform="translate(${x} ${y})"><path d="M -28 0 A 28 28 0 0 1 28 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-28" y1="0" x2="28" y2="0" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><text y="14" text-anchor="middle" font-size="11" font-weight="800" fill="${color}">3~</text><text y="52" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  ...
  if(entity.symbolId === "exhaust-fan") return `<g ${base} transform="translate(${x} ${y})"><circle r="22" fill="none" stroke="${color}" stroke-width="2.5"/><path d="M 0 0 L 0 -18 A 9 9 0 0 1 9 -3 Z" fill="${color}" opacity="0.85"/><path d="M 0 0 L 15 9 A 9 9 0 0 1 -1 15 Z" fill="${color}" opacity="0.85"/><path d="M 0 0 L -15 9 A 9 9 0 0 1 1 -15 Z" fill="${color}" opacity="0.85"/><text y="42" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "water-heater") return `<g ${base} transform="translate(${x} ${y})"><rect x="-18" y="-30" width="36" height="60" rx="8" fill="none" stroke="${color}" stroke-width="2.5"/><path d="M 0 -14 C -6 -6 -6 2 0 6 C 6 2 6 -6 0 -14 Z" fill="none" stroke="${color}" stroke-width="1.5"/><text y="46" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  ...
  if(entity.symbolId === "smoke-detector") return `<g ${base} transform="translate(${x} ${y})"><circle r="20" fill="none" stroke="${color}" stroke-width="2.5"/><circle r="7" fill="none" stroke="${color}" stroke-width="1.5"/><circle r="2" fill="${color}"/><text y="40" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "data-point") return `<g ${base} transform="translate(${x} ${y})"><rect x="-16" y="-16" width="32" height="32" rx="4" fill="none" stroke="${color}" stroke-width="2.5"/><text y="6" text-anchor="middle" font-size="12" font-weight="800" fill="${color}">D</text><text y="38" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "tv-point") return `<g ${base} transform="translate(${x} ${y})"><rect x="-16" y="-16" width="32" height="32" rx="4" fill="none" stroke="${color}" stroke-width="2.5"/><text y="6" text-anchor="middle" font-size="11" font-weight="800" fill="${color}">TV</text><text y="38" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
