...
function renderSymbol(entity, symbols = CAD_SYMBOLS){
  ...
  if(entity.symbolId === "outlet") return `<g ${base} transform="translate(${x} ${y})"><path d="M -24 0 A 24 24 0 0 1 24 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-24" y1="0" x2="24" y2="0" stroke="${color}" stroke-width="2.5"/><line x1="0" y1="-12" x2="0" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="45" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-double") return `<g ${base} transform="translate(${x} ${y})"><path d="M -26 0 A 26 26 0 0 1 26 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-26" y1="0" x2="26" y2="0" stroke="${color}" stroke-width="2.5"/><line x1="-9" y1="-13" x2="-9" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="9" y1="-13" x2="9" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="50" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
  if(entity.symbolId === "outlet-triple") return `<g ${base} transform="translate(${x} ${y})"><path d="M -28 0 A 28 28 0 0 1 28 0" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round"/><line x1="-28" y1="0" x2="28" y2="0" stroke="${color}" stroke-width="2.5"/><line x1="-12" y1="-14" x2="-12" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="0" y1="-14" x2="0" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><line x1="12" y1="-14" x2="12" y2="-1" stroke="${color}" stroke-width="2" stroke-linecap="round"/><text y="52" text-anchor="middle" font-size="11" font-weight="700" fill="${color}">${label}</text></g>`;
